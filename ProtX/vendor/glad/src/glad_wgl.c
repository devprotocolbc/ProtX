...
static void load_WGL_AMD_gpu_association(GLADloadproc load) {
	...
	glad_wglCreateAssociatedContextAttribsAMD = (PFNWGLCREATEASSOCIATEDCONTEXTATTRIBSAMDPROC) load(
	...
	glad_wglMakeAssociatedContextCurrentAMD = (PFNWGLMAKEASSOCIATEDCONTEXTCURRENTAMDPROC) load(
		"wglMakeAssociatedContextCurrentAMD");
	glad_wglGetCurrentAssociatedContextAMD = (PFNWGLGETCURRENTASSOCIATEDCONTEXTAMDPROC) load(
...
static void load_WGL_EXT_display_color_table(GLADloadproc load) {
	...
	glad_wglDestroyDisplayColorTableEXT = (PFNWGLDESTROYDISPLAYCOLORTABLEEXTPROC)
			load("wglDestroyDisplayColorTableEXT");
}
...
static void load_WGL_I3D_digital_video_control(GLADloadproc load) {
	...
	glad_wglGetDigitalVideoParametersI3D = (PFNWGLGETDIGITALVIDEOPARAMETERSI3DPROC) load(
		"wglGetDigitalVideoParametersI3D");
	glad_wglSetDigitalVideoParametersI3D = (PFNWGLSETDIGITALVIDEOPARAMETERSI3DPROC) load(
...
static void load_WGL_I3D_genlock(GLADloadproc load) {
	...
	glad_wglQueryGenlockMaxSourceDelayI3D = (PFNWGLQUERYGENLOCKMAXSOURCEDELAYI3DPROC) load(
...
static void load_WGL_I3D_image_buffer(GLADloadproc load) {
	...
	glad_wglReleaseImageBufferEventsI3D = (PFNWGLRELEASEIMAGEBUFFEREVENTSI3DPROC)
			load("wglReleaseImageBufferEventsI3D");
}
...
static void load_WGL_NV_video_capture(GLADloadproc load) {
	...
	glad_wglEnumerateVideoCaptureDevicesNV = (PFNWGLENUMERATEVIDEOCAPTUREDEVICESNVPROC) load(
	...
	glad_wglReleaseVideoCaptureDeviceNV = (PFNWGLRELEASEVIDEOCAPTUREDEVICENVPROC)
			load("wglReleaseVideoCaptureDeviceNV");
}
